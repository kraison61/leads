        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-center">
            ...
            <div className="col-span-3 order-2 lg:order-1">
                <p className="mt-8 text-sm sm:text-base md:text-lg font-medium leading-[1.5rem] sm:leading-[1.8rem] md:leading-[2.5rem]">
                    Lorem ipsum dolor sit amet consectetur, adipisicing elit. Repellat labore nulla tempora harum deleniti est unde corporis voluptates necessitatibus provident, tempore, eius, rerum voluptatem inventore ut distinctio aspernatur. Ipsam, modi?
                </p>
